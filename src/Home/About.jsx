                        ...
                        <motion.div
                            ...
                            <div className="mt-10 lg:mt-0">
                                ...
                                <a
                                    ...
                                    className="inline-flex items-center justify-center py-3 text-base font-medium text-center  px-7 bg-gradient-to-br from-blue-200 to-blue-500 text-white px-4 py-2 hover:bg-blue-600"
                                >
                                    Get Started
                                </a>
                            </div>
